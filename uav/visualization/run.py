...
def run_all(results_filepath: str, friedman_png_filepath: str, wilcoxon_png_filepath: str, full_analysis_png_filepath_base: str, full_analyses: list[FullAnalaysisRegistry]):
